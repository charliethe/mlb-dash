  ...
  return (
    ...
    <div className="space-y-4">
      <div className="flex items-center gap-3">
        ...
        <FreshnessIndicator lastUpdated={lastUpdated} loading={loading} onRefresh={loadTransactions} />
      ...
      <Card>
        <CardContent className="p-0">
          {loading ? (
            ...
            <ErrorState message="Failed to load transactions" onRetry={loadTransactions} />
          ) : filtered.length === 0 ? (
